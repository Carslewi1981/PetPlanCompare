...
const PET_TYPES: PetType[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/9/9c/Hasenkaninchen.jpg", caption: "Belgian Hare", detail: "Mocha, 3 yrs", fallback: "🐰" },
  ...
  },
  {
    ...
    photos: [
      ...
      { url: u("1774905285081-01b7fbb269a4"), caption: "Green Lizard", detail: "Rocky, 2 yrs", fallback: "🦎" },
    ],
  },
  {
    id: "exotic",
    ...
    photos: [
      ...
      { url: "https://upload.wikimedia.org/wikipedia/commons/4/47/Octodon_degus_-Heidelberg_Zoo%2C_Germany-8a.jpg", caption: "Degu", detail: "Chip, 2 yrs", fallback: "🐭" },
    ],
  },
];
